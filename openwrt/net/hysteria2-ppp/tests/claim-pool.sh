...
# Redirected because hysteria_state_clear removes this too. Every path that
# function touches has to be pointed at the scratch directory or the suite issues
# rm -f against the host's real /var/run.
