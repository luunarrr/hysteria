...
type Config struct {
	...
	// InitialDestConnectionID, if set, overrides the randomly generated
	// initial Destination Connection ID used in the first Initial packet.
	// Only used on the client side (Dial / DialEarly).
